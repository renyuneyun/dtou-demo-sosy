export const APPS = [
    {
        ...
        result: 'allowed',
        resultReason: 'App declares purpose vocab:provide-health-suggestions. ' +
    ...
    },
    {
        ...
        result: 'allowed',
        resultReason: 'Same purpose (provide-health-suggestions), no prohibition match. ' +
    ...
    },
    {
        ...
        result: 'denied',
        resultReason: 'App declares purpose vocab:commercial-research. ' +
