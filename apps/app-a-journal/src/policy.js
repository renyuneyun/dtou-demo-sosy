import { APP_WELLNESS_JOURNAL, PURPOSE_HEALTH_SUGGESTIONS, CONCEPT_HEALTH_SUGGESTIONS, } from '@dtou-demo/dtou-client';
const APP = 'urn:dtou-demo:app#';
const mkPort = (suffix, name) => ({ uri: `${APP}${suffix}`, name });
export const APP_A_POLICY = {
    uri: `${APP}WellnessJournalPolicy`,
    appNameUri: APP_WELLNESS_JOURNAL,
    appDisplayName: 'Daily Wellness Journal',
    description: 'A personal journaling app. Reads your health metrics (heart rate, steps, sleep) ' +
